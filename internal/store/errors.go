...
var (
	...
	ErrMonitoringIncidentNotFound      = errors.New("monitoring incident not found")
	ErrMonitoringTemplateClassConflict = errors.New("monitoring template already belongs to another incident class")

...
func TestResolveDeviceName_TrimsStoredDisplayName(t *testing.T) {
	...
	peers := []store.P2PPeer{
		...
		{PeerID: "12D3KooWLegacy", DisplayName: "peer-laptop.ts.net lan  "}, // trailing whitespace
	...
	tests := []struct {
		...
		{"legacy stored has trailing whitespace, input clean", "peer-laptop.ts.net lan", "12D3KooWLegacy"},

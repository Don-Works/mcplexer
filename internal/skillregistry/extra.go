...
// the W4 fields (requires, produces, consumes, phases, refinement) as
...
//
// The five keys are pulled out of `meta` BEFORE the metadata blob is
...
var manifestExtraKeys = []string{
	"requires", "produces", "consumes", "phases", "refinement",
}

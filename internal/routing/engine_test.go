...
func (m *mockRouteStore) ListPendingLogTemplates(context.Context, []string, int) ([]*store.LogTemplate, error) {
	return nil, nil
}
...
func (m *mockRouteStore) GetMonitoringIncidentByClass(context.Context, string, string) (*store.MonitoringIncident, error) {
	return nil, store.ErrMonitoringIncidentNotFound
}
func (m *mockRouteStore) ListMonitoringIncidentsByTemplateIDs(context.Context, string, []string) ([]*store.MonitoringIncident, error) {
	return nil, nil
}
func (m *mockRouteStore) RecordMonitoringTriage(context.Context, store.MonitoringTriageRecord) (*store.MonitoringTriageResult, error) {
	return nil, nil
}
func (m *mockRouteStore) ClaimMonitoringTriageTemplates(context.Context, string, string, []string, time.Time) error {
	return nil
}
func (m *mockRouteStore) CompleteMonitoringTriage(context.Context, store.MonitoringTriageCompletion) error {
	return nil
}
func (m *mockRouteStore) MarkMonitoringIncidentNotified(context.Context, string, string, time.Time) error {
	return nil
}
func (m *mockRouteStore) HasMonitoringTriageReceipt(context.Context, string, string) (bool, error) {
	return false, nil
}

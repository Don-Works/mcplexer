...
// mcpx__call_tool + mcpx__execute_code, and where the rest (mesh, secrets,
// memory) lives. The
...
// preamble's central promise, "your top-level tool surface is exactly the
// three mcpx entrypoints", is simply false for them: it

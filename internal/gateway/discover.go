...
func searchToolsDefinition() Tool {
	return Tool{
		...
		Description: "Search for any callable function reachable from mcplexer — " +
			...
			"intents in one call. Results are returned grouped by query.\n" +
			...
			"- mcpx — admin operations (workspaces, servers, routes) when CWD-gated\n" +
			"- skill — search/get/publish reusable skills from the shared registry\n" +

	...
	return []Tool{
		{
			...
			InputSchema: json.RawMessage(`{
				...
				"properties": {
					...
					"kind": {"type": "string", "enum": ["note", "fact"], "description": "Memory kind (default: note)."},

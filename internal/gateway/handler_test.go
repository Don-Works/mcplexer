...
// Stubs — AuditStore.
func (m *mockStore) InsertAuditRecord(_ context.Context, rec *store.AuditRecord) error {
	if rec != nil {
		m.auditRecords = append(m.auditRecords, *rec)
	}
	return nil
}
...
func (m *mockStore) ListPendingLogTemplates(context.Context, []string, int) ([]*store.LogTemplate, error) {
	return nil, nil
}
...
func (m *mockStore) GetMonitoringIncidentByClass(context.Context, string, string) (*store.MonitoringIncident, error) {
	return nil, store.ErrMonitoringIncidentNotFound
}
func (m *mockStore) ListMonitoringIncidentsByTemplateIDs(context.Context, string, []string) ([]*store.MonitoringIncident, error) {
	return nil, nil
}
func (m *mockStore) RecordMonitoringTriage(context.Context, store.MonitoringTriageRecord) (*store.MonitoringTriageResult, error) {
	return nil, store.ErrMonitoringIncidentNotFound
}
func (m *mockStore) ClaimMonitoringTriageTemplates(context.Context, string, string, []string, time.Time) error {
	return nil
}
func (m *mockStore) CompleteMonitoringTriage(context.Context, store.MonitoringTriageCompletion) error {
	return nil
}
func (m *mockStore) MarkMonitoringIncidentNotified(context.Context, string, string, time.Time) error {
	return nil
}
func (m *mockStore) HasMonitoringTriageReceipt(context.Context, string, string) (bool, error) {
	return false, nil
}

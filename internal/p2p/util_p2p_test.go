...
func TestDialableAddrsForPairing(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			in: []string{
				"/ip4/192.168.8.106/tcp/49527",
				"/dnsaddr/bootstrap.libp2p.io/p2p/QmNnoo/p2p-circuit",
				"/ip4/51.81.93.51/tcp/4001/p2p/QmQ/p2p-circuit",
			},
			want: []string{"/ip4/192.168.8.106/tcp/49527"},
		},
		{
			...
			want: []string{"/ip4/100.87.197.128/tcp/49527"},
		},
		{
		...
		{
			name: "real-world bloated list shrinks dramatically",
			in: []string{
				"/ip4/100.87.197.128/tcp/49527",
				"/ip4/100.87.197.128/udp/58906/quic-v1",

...
func TestDialableAddrsForPairing(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			in: []string{
				"/ip4/100.64.0.1/tcp/49527",
				"/ip4/203.0.113.106/udp/58906/quic-v1",
			},
			want: []string{
				"/ip4/100.64.0.1/tcp/49527",
				"/ip4/203.0.113.106/udp/58906/quic-v1",
		...
		},
		{
			...
			in: []string{
				"/ip4/100.64.0.1/tcp/49527",
				"/ip4/198.51.100.51/udp/4001/quic-v1/webtransport/certhash/uEi.../p2p/Qm.../p2p-circuit",
		...
		},
		{
			...
			in: []string{
				"/ip4/203.0.113.106/tcp/49527",
				"/ip6/fe80::1/tcp/49530",
				"/ip6/::1/tcp/49530",
				"/ip6/fd00::1234/tcp/49530",
			},
			want: []string{
				"/ip4/203.0.113.106/tcp/49527",
				"/ip6/fd00::1234/tcp/49530",
		...
		},
		{
			...
			in: []string{
				"/ip4/100.64.0.1/tcp/49527",
				"/ip4/100.64.0.1/udp/58906/quic-v1",
				"/ip4/127.0.0.1/tcp/49527",
				"/ip4/203.0.113.106/tcp/49527",
				"/ip6/::1/tcp/49530",
				"/ip6/fd00::1234/tcp/49530",
				"/dnsaddr/bootstrap.libp2p.io/p2p/Qm/p2p-circuit",
				"/ip4/198.51.100.51/tcp/4001/p2p/Qm/p2p-circuit",
				"/ip4/198.51.100.51/udp/4001/quic-v1/webtransport/certhash/uEi/p2p/Qm/p2p-circuit",
				"/ip6/2001:db8::51/tcp/4001/p2p/Qm/p2p-circuit",
			},
			want: []string{
				"/ip4/100.64.0.1/tcp/49527",
				"/ip4/100.64.0.1/udp/58906/quic-v1",

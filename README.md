...
```powershell
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/Don-Works/mcplexer/main/scripts/install-release.ps1)))
```

Pass `--version vX.Y.Z` on macOS/Linux or `-Version vX.Y.Z` on Windows

...
//
//   - the short hostname              ("max-mac")        — what people type
//   - the mDNS / Bonjour form         ("max-mac.local")  — LAN discovery
//   - the full domain-qualified form  ("max-mac.ts.net") — Tailscale, VPNs
//
...
func localHostnames() []string {
	...
	// stamped multiple aliases (e.g. "max-mac.ts.net lan"). Split + add

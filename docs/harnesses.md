...
- `secret__prompt`
- `secret__list_refs`
- `mcpx__retrieve` (expands reversible compression markers)
...
- `retrieve` maps to `mcpx__retrieve`
...
the five top-level tools, fetch the full `using-mcplexer` skill contract through
